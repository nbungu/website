              ...
              <div className="list-group">
                  <a href="#" className="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
                    ...
                    <div className="d-flex gap-2 w-100 justify-content-between">
                      <div>
                        <h6 className="mb-0" style={{textAlign: 'left'}}>Training</h6>
                        <p className="mb-0 opacity-75" style={{textAlign: 'left'}}>19:00 - 21:00 Uhr</p>
                      </div>
                      <div>
                        <h6 className="mb-0 text-nowrap" style={{textAlign: 'right'}}>Do, 07.10.2023</h6>
                        <p className="mb-0 opacity-75 text-nowrap" style={{textAlign: 'right'}}>Adelberg</p>
                      </div>                      
                    </div>
                  </a>
                  <a href="#" className="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
                    ...
                    <div className="d-flex gap-2 w-100 justify-content-between">
                      <div>
                        <h6 className="mb-0" style={{textAlign: 'left'}}>Freundschaftsspiel</h6>
                        <p className="mb-0 opacity-75" style={{textAlign: 'left'}}>20:15 - 21:30, Wernau</p>
                      </div>
